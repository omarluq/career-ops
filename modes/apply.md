...
Interactive mode for when the candidate is filling out an application form in Chrome. Reads what's on screen, loads prior context for the listing, and generates personalized answers for each form question.

...
8. Select top 3-4 most relevant projects for the listing
...
**NEVER add skills the candidate doesn't have. Only reformulate real experience using the exact vocabulary from the JD.**
...
Update tracker if the listing is already registered: change PDF from ❌ to ✅.

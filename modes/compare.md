...
For each listing: score in each dimension, weighted total score.
Final ranking + recommendation with time-to-offer considerations.

Ask the user for the listings if not in context. Can be text, URLs, or references to already-evaluated listings in the tracker.

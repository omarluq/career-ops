...
Run exactly as the `evaluate` mode (read `modes/evaluate.md` for all blocks A-F).
...
- **Selective without being conceited**: "I've been intentional about finding a team where I can contribute meaningfully from day one"
...
Record in the SQLite database via `career-ops merge` or MCP tools, including Report and PDF as ✅.

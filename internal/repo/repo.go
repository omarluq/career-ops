// Package repo defines the repository interface that abstracts data access
// for career-ops pipeline data. Implementations can back onto SQLite, markdown
...
type Repository interface {
	...
	ListPipeline(ctx context.Context, status string) ([]PipelineEntry, error)
	...
	ListScanHistory(ctx context.Context) ([]ScanRecord, error)
...
// PipelineEntry represents a URL queued for evaluation.
